...
/* global test, expect */
test('Fetching 1 image from rule34', () => {
	kaori.search('rule34', { limit: 1 })
		.then(images => {
...
test('Fetching 1 random image from rule34', () => {
	kaori.search('rule34', { limit: 10, random: true })
		.then(images => {
			expect(images[0].common.fileURL).toBeDefined();
			expect(images[0].common.id).toBeDefined();
			expect(images[0].common.tags).toBeDefined();
...
test('Fetching 10 image from rule34', () => {
	kaori.search('rule34', { limit: 10 })
		.then(images => {
			expect(images[0].common.fileURL).toBeDefined();
			expect(images[0].common.id).toBeDefined();
			expect(images[0].common.tags).toBeDefined();
...
test('Fetching 10 random image from rule34', () => {
	kaori.search('rule34', { limit: 10, random: true })
		.then(images => {
			expect(images[0].common.fileURL).toBeDefined();
			expect(images[0].common.id).toBeDefined();
